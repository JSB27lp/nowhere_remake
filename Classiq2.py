...
class Room(pygame.sprite.Sprite):
    def __init__(self, room_name_):
        ...
        tmp_room_mask = None
        if room_name_ == "antichamber2" or room_name_ == "blood_room" or room_name_ == "test_room5" or room_name_ == "test_room4" or room_name_ == "back_room" or room_name_ == "antichamber":
