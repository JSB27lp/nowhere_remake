...
def display_elements(test_room,player):
    #room
...
def get_new_room_name(room_index,actually_room_name):
    ...
    if room%nb_room == 0:
        if actually_room_name == "blood_room" or actually_room_name == "blood_room_jail" :
            return "blood_room_jail"
        else :
...
def start():
    ...
    while state_game == 0:
        ...
        player.test_if_i_can_become_light(test_room.flamme)
        ...
        display_elements(test_room,player)
